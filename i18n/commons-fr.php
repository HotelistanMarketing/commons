...
const TRC = array(
    ...
    "form_name_opt" => "Nom et Prénom (facultatif)",
    "form_mail" => "Courrier (facultatif)",
    ...
    "wp_message" => "Bonjour, je voudrais savoir sur les services et les prix offerts pour %s en Turquie.",
    ...
    "wp_form_button" => "Continuer vers WhatsApp",
);